...
namespace varexp
{
  namespace internal
  {
    ...
    class SANITY_DLL_EXPORT parser
    {
    protected:
    ...
    SANITY_DLL_EXPORT void cut_out_offset(string& data, unsigned int num1, unsigned int num2, bool is_range);
    SANITY_DLL_EXPORT void padding(string& data, unsigned int width, const string& fillstring, char position);
    SANITY_DLL_EXPORT void search_and_replace(string& data, const string& search, const string& replace, const string& flags);
    SANITY_DLL_EXPORT void transpose(string& data, const string& srcclass, const string& dstclass);
    SANITY_DLL_EXPORT void expand_character_class(const char *desc, char_class_t char_class);
  }
}
